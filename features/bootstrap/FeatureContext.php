...
class FeatureContext extends BehatContext implements ClosuredContextInterface {
	...
	public function download_wp( $subdir = '' ) {
		...
		mkdir( $dest_dir . '/wp-content/plugins/dashboard-directory-size' );
		mkdir( $dest_dir . '/wp-content/plugins/dashboard-directory-size/includes' );

		$this->proc( Utils\esc_cmd( "cp %s %s", dirname( dirname( __DIR__ ) ) . '/dashboard-directory-size.php', $dest_dir . '/wp-content/plugins/dashboard-directory-size/' ) )->run_check();
		$this->proc( Utils\esc_cmd( "cp -r %s/* %s", dirname( dirname( __DIR__ ) ) . '/includes', $dest_dir . '/wp-content/plugins/dashboard-directory-size/includes/' ) )->run_check();
